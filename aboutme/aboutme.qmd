...
<div style="text-align:center; margin-top:1.5em;">
  <a href="https://github.com/NandiniKodali988" target="_blank" style="display:inline-block; border:1px solid #555; padding:10px 20px; border-radius:5px; text-decoration:none; color:#333; margin-right:10px;">
    <i class="fab fa-github"></i> GitHub
  </a>
  <a href="https://nandinikodali.georgetown.domains/portfolio/" target="_blank" style="display:inline-block; border:1px solid #555; padding:10px 20px; border-radius:5px; text-decoration:none; color:#333;">
